...
using (var scope = app.Services.CreateScope()){
    //this gives you access to all the services you registered earlier, like BDContext
    var services = scope.ServiceProvider;
    //this gets an instance of you database context= the thing that talks to your database
